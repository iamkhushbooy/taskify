    ...
    return (
        <div className='w-full  bg-slate-400 h-20 flex justify-between items-center flex-col'>
            ...
            <div className='w-full h-[60%] flex justify-center items-center'>
                <button onClick={() => setSearchoption(!searchoption)} className='text-blue-800 border-[1px] border-blue-800 p-1 mr-3 rounded-lg'>Find Task</button>
                {
                    searchoption &&
                    <>
                        ...
                        <button onClick={()=>router.push(`/date/${date}`)} className='p-1 text-green-800 border border-green-800 rounded-lg ml-3'>Search</button></>}
                        {!bydate&&<button onClick={()=>setBytitle(!bytitle)} className='text-blue-800 border-[1px] border-blue-800 p-1 mr-3 rounded-lg'>By Title</button>}
                        { bytitle&&<>
                        ...
                        <button onClick={()=>router.push(`/title/${title}`)} className='p-1 rounded-lg ml-3 text-green-800 border border-green-800 '>Search</button></>}
